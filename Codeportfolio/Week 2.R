...
# Checking the class of AP - This function is useful to understand the class of the object
class(AP)
...
#along with plots, renaming axes appropriately
...
layout(1:2) # this helps to see two plots in a window
